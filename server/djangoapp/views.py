...
def login_request(request):
    ...
    if request.method == "POST":
        ...
        return render(request, 'djangoapp/indexp.html', context)
...
#     return ""
    ...
    if request.method == 'GET':
        ...
        if request.user.is_authenticated:
            ...
            payload["car_make"] = car.name
            payload["car_model"] = car.name
            payload["car_year"] = int(car.year.strftime("%Y"))
            new_payload = {}
            new_payload["review"] = payload
            review_post_url = "https://au-syd.functions.appdomain.cloud/api/v1/web/a4851288-2067-4980-8b25-eac6863f38b4/dealership-package/post-review"
